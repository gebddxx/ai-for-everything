...
result = crew.kickoff()  # 两个Agent自动协作完成任务`})})]})]})}function y({t,children:o}){return e.jsxs("div",{style:{background:"var(--bg-card)",borderRadius:12,padding:22,boxShadow:"var(--shadow)",marginBottom:16},children:[e.jsx("h3",{style:{marginBottom:12,color:"var(--text)",fontSize:16},children:t}),o]})}function D({h:t,r:o}){return e.jsxs("table",{style:{width:"100%",borderCollapse:"collapse",fontSize:13},children:[e.jsx("thead",{children:e.jsx("tr",{children:t.map(s=>e.jsx("th",{style:{padding:"8px 12px",textAlign:"left",borderBottom:"2px solid var(--border)",color:"var(--text)",fontWeight:600},children:s},s))})}),e.jsx("tbody",{children:o.map((s,n)=>e.jsx("tr",{children:s.map((a,x)=>e.jsx("td",{style:{padding:"8px 12px",borderBottom:"1px solid var(--border)",color:"var(--text-secondary)"},children:a},x))},n))})]})}function G({children:t}){return e.jsx("pre",{style:{background:"#0f172a",color:"#e2e8f0",borderRadius:8,padding:16,fontSize:13,lineHeight:1.6,overflowX:"auto",whiteSpace:"pre-wrap",wordBreak:"break-word",margin:0},children:e.jsx("code",{children:t})})}function M(){const{lang:t}=d(),o=(s,n,a)=>t==="zh-CN"?n:t==="zh-TW"?a:s;return e.jsxs("div",{className:i.page,children:[e.jsxs("div",{className:i.head,children:[e.jsxs("h2",{className:i.title,children:["💬 ",o("Personal AI Assistants","个人 AI 助手","個人 AI 助手")]}),e.jsx("p",{className:i.subtitle,children:o("Build your own AI assistant for daily tasks","搭建你自己的 AI 助手处理日常事务","搭建你自己的 AI 助手處理日常事務")})]}),e.jsxs("div",{className:i.cases,children:[e.jsx(k,{t:o("🛠 Platforms","🛠 平台","🛠 平台"),children:e.jsx(R,{h:["Platform","Key Feature"],r:[["ChatGPT GPTs",o("No-code custom GPT, upload knowledge files, share or sell","零代码定制GPT,上传知识文件,可分享/出售","零程式碼定製GPT,上傳知識檔案,可分享/出售")],["Claude Projects",o("Custom instructions + knowledge base, team sharing, 200K context","自定义指令+知识库, 团队共享, 200K上下文","自定義指令+知識庫, 團隊共享, 200K上下文")],["Gemini Gems",o("Google ecosystem, personalized AI with custom instructions","Google生态,个性化AI,自定义指令","Google生態,個性化AI,自定義指令")],["Coze/Dify",o("Build complex bots with plugins, workflows, knowledge bases","插件+工作流+知识库,构建复杂Bot","插件+工作流+知識庫,構建複雜Bot")],["Replit Agent",o("AI builds full-stack apps from natural language descriptions","自然语言描述→AI构建全栈应用","自然語言描述→AI構建全棧應用")]]})}),e.jsx(k,{t:o("💡 Example Setups","💡 示例配置","💡 示例配置"),children:e.jsx(L,{children:`# 个人研究助手 (ChatGPT GPTs / Claude Project)
Instructions:
...
- 自动检测时间冲突并建议替代时间
- 每周日晚生成"本周时间分配报告"`})})]})]})}function k({t,children:o}){return e.jsxs("div",{style:{background:"var(--bg-card)",borderRadius:12,padding:22,boxShadow:"var(--shadow)",marginBottom:16},children:[e.jsx("h3",{style:{marginBottom:12,color:"var(--text)",fontSize:16},children:t}),o]})}function R({h:t,r:o}){return e.jsxs("table",{style:{width:"100%",borderCollapse:"collapse",fontSize:13},children:[e.jsx("thead",{children:e.jsx("tr",{children:t.map(s=>e.jsx("th",{style:{padding:"8px 12px",textAlign:"left",borderBottom:"2px solid var(--border)",color:"var(--text)",fontWeight:600},children:s},s))})}),e.jsx("tbody",{children:o.map((s,n)=>e.jsx("tr",{children:s.map((a,x)=>e.jsx("td",{style:{padding:"8px 12px",borderBottom:"1px solid var(--border)",color:"var(--text-secondary)"},children:a},x))},n))})]})}function L({children:t}){return e.jsx("pre",{style:{background:"#0f172a",color:"#e2e8f0",borderRadius:8,padding:16,fontSize:13,lineHeight:1.6,overflowX:"auto",whiteSpace:"pre-wrap",wordBreak:"break-word",margin:0},children:e.jsx("code",{children:t})})}function _(){const{lang:t}=d(),o=(s,n,a)=>t==="zh-CN"?n:t==="zh-TW"?a:s;return e.jsxs("div",{className:i.page,children:[e.jsxs("div",{className:i.head,children:[e.jsxs("h2",{className:i.title,children:["⚡ ",o("Workflow Automation","工作流自动化","工作流自動化")]}),e.jsx("p",{className:i.subtitle,children:o("Connect AI with thousands of apps to automate workflows","连接 AI 和数千应用, 自动化你的工作流","連接 AI 和數千應用, 自動化你的工作流")})]}),e.jsxs("div",{className:i.cases,children:[e.jsx(b,{t:o("🛠 Automation Platforms","🛠 自动化平台","🛠 自動化平台"),children:e.jsx(B,{h:["Platform","Apps Connected","Best For"],r:[["n8n","400+",o("Self-hosted, open source, AI nodes, code-capable. Best for developers","自托管、开源、AI节点、可写代码。适合开发者","自託管、開源、AI節點、可寫程式碼。適合開發者")],["Make","2000+",o("Visual scenario builder, complex branching logic. Best for power users","可视化场景构建、复杂分支逻辑。适合高级用户","可視化場景構建、複雜分支邏輯。適合高級用戶")],["Zapier","7000+",o("Easiest to start, largest app library. Best for quick automations","最易上手、最大应用库。适合快速自动化","最易上手、最大應用庫。適合快速自動化")],["Dify","AI-native",o("LLM workflow builder, RAG pipeline, agent mode, one-click API","LLM工作流构建器,RAG管道,Agent模式,一键API","LLM工作流構建器,RAG管道,Agent模式,一鍵API")]]})}),e.jsx(b,{t:o("💡 Automation Ideas","💡 自动化创意","💡 自動化創意"),children:e.jsx(K,{children:`# 1. 自动日报生成
触发: 每天18:00
→ AI总结当日Slack/飞书消息
→ 提取各项目进度 + 关键决策
...
→ 定时发布到各平台`})})]})]})}function b({t,children:o}){return e.jsxs("div",{style:{background:"var(--bg-card)",borderRadius:12,padding:22,boxShadow:"var(--shadow)",marginBottom:16},children:[e.jsx("h3",{style:{marginBottom:12,color:"var(--text)",fontSize:16},children:t}),o]})}function B({h:t,r:o}){return e.jsxs("table",{style:{width:"100%",borderCollapse:"collapse",fontSize:13},children:[e.jsx("thead",{children:e.jsx("tr",{children:t.map(s=>e.jsx("th",{style:{padding:"8px 12px",textAlign:"left",borderBottom:"2px solid var(--border)",color:"var(--text)",fontWeight:600},children:s},s))})}),e.jsx("tbody",{children:o.map((s,n)=>e.jsx("tr",{children:s.map((a,x)=>e.jsx("td",{style:{padding:"8px 12px",borderBottom:"1px solid var(--border)",color:"var(--text-secondary)"},children:a},x))},n))})]})}function K({children:t}){return e.jsx("pre",{style:{background:"#0f172a",color:"#e2e8f0",borderRadius:8,padding:16,fontSize:13,lineHeight:1.6,overflowX:"auto",whiteSpace:"pre-wrap",wordBreak:"break-word",margin:0},children:e.jsx("code",{children:t})})}function F(){const{lang:t}=d(),o=(s,n,a)=>t==="zh-CN"?n:t==="zh-TW"?a:s;return e.jsxs("div",{className:i.page,children:[e.jsxs("div",{className:i.head,children:[e.jsxs("h2",{className:i.title,children:["🕸️ ",o("Multi-Agent Systems","多 Agent 协作","多 Agent 協作")]}),e.jsx("p",{className:i.subtitle,children:o("Multiple agents collaborating — each with a role — to solve complex problems","多个Agent分工协作,各自承担不同角色,共同解决复杂问题","多個Agent分工協作,各自承擔不同角色,共同解決複雜問題")})]}),e.jsxs("div",{className:i.cases,children:[e.jsx(w,{t:o("🧩 Design Patterns","🧩 设计模式","🧩 設計模式"),children:e.jsx(H,{h:["Pattern","How It Works","Best For"],r:[["Sequential",o("Agent A → Agent B → Agent C. Each passes output to the next","Agent A→Agent B→Agent C, 流水线式传递","Agent A→Agent B→Agent C, 流水線式傳遞"),o("Linear workflows: research→write→review","线性工作流:研究→撰写→审核","線性工作流:研究→撰寫→審核")],["Router",o("One dispatcher agent routes tasks to specialized agents","一个调度Agent将任务路由给不同专长Agent","一個調度Agent將任務路由給不同專長Agent"),o("Customer support: billing/tech/general","客服:账单/技术/通用分流","客服:帳單/技術/通用分流")],["Debate",o("Multiple agents debate different viewpoints, then synthesize","多个Agent从不同立场辩论,然后综合观点","多個Agent從不同立場辯論,然後綜合觀點"),o("Decision making, strategy planning","决策分析、战略规划","決策分析、戰略規劃")],["Hierarchical",o("Manager agent delegates to worker agents, reviews results","管理者Agent分配任务→执行Agent干活→管理者审核","管理者Agent分配任務→執行Agent幹活→管理者審核"),o("Complex projects with quality control","需要质量控制的复杂项目","需要品質控制的複雜項目")]]})}),e.jsx(w,{t:o("💡 Example: Research Team","💡 示例：研究团队","💡 示例：研究團隊"),children:e.jsx(V,{children:`# 5个Agent协作完成深度调研报告:

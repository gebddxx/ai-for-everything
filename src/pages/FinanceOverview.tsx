...
return(<div className={styles.page}><div className={styles.head}><h2 className={styles.title}>💰 {L('AI Finance','AI 金融科技','AI 金融科技')}</h2><p className={styles.subtitle}>{L('20 AI tools — Fraud, Trading, Risk, Wealth','20款AI金融工具——反欺诈、算法交易、风险评估、智能理财','20款AI金融工具——反欺詐、算法交易、風險評估、智能理財')}</p></div>

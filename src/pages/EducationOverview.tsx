...
return(<div className={styles.page}><div className={styles.head}><h2 className={styles.title}>📚 {L('AI Education','AI 教育科技','AI 教育科技')}</h2><p className={styles.subtitle}>{L('18 AI tools — Personalized Learning, Tutoring, Grading, Content','18款AI教育工具——个性化学习、智能辅导、自动评分、内容生成','18款AI教育工具——個性化學習、智能輔導、自動評分、內容生成')}</p></div>

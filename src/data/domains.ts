...
export const domains: Domain[] = [
  ...
  },
  {
    ...
    subModules: [
      ...
      { key: 'writing', icon: '✍️', title: { en: 'Writing Tools', 'zh-CN': 'AI写作工具', 'zh-TW': 'AI寫作工具' } },
      { key: 'image-gen', icon: '🎨', title: { en: 'Image Tools', 'zh-CN': 'AI绘画工具', 'zh-TW': 'AI繪畫工具' } },
      { key: 'video-gen-tool', icon: '🎬', title: { en: 'Video Tools', 'zh-CN': 'AI视频工具', 'zh-TW': 'AI影片工具' } },
      { key: 'audio-gen-tool', icon: '🎵', title: { en: 'Audio Tools', 'zh-CN': 'AI音频工具', 'zh-TW': 'AI音頻工具' } },
    ],
  },
  {
    key: 'ai-dev',
    ...
    subModules: [
      ...
      { key: 'claude-code', icon: '🟠', title: { en: 'Claude Code', 'zh-CN': 'Claude Code 教程', 'zh-TW': 'Claude Code 教學' } },
